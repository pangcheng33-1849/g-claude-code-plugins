...
def build_parser() -> argparse.ArgumentParser:
    ...
    create_parser.add_argument("--tenant-access-token")
    ...
    update_parser.add_argument("--user-access-token")
    update_parser.add_argument("--tenant-access-token")
    ...
    import_parser.add_argument("--user-access-token")
    import_parser.add_argument("--tenant-access-token")
    ...
    share_parser.add_argument("--user-access-token")
    share_parser.add_argument("--tenant-access-token")
    ...
    update_share_parser.add_argument("--user-access-token")
    update_share_parser.add_argument("--tenant-access-token")
    ...
    remove_share_parser.add_argument("--user-access-token")
    remove_share_parser.add_argument("--tenant-access-token")
    ...
    transfer_owner_parser.add_argument("--user-access-token")
    transfer_owner_parser.add_argument("--tenant-access-token")
    ...
    list_docs_parser.add_argument("--user-access-token")
    list_docs_parser.add_argument("--tenant-access-token")
    ...
    resolve_wiki_node_parser.add_argument("--user-access-token")
    resolve_wiki_node_parser.add_argument("--tenant-access-token")
    ...
    get_comments_parser.add_argument("--user-access-token")
    get_comments_parser.add_argument("--tenant-access-token")
    ...
    add_comments_parser.add_argument("--user-access-token")
    add_comments_parser.add_argument("--tenant-access-token")
    ...
    fetch_parser.add_argument("--user-access-token")
    fetch_parser.add_argument("--tenant-access-token")
